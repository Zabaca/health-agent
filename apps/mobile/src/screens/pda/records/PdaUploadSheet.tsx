...
type R = RouteProp<PdaRecordsParamList, "PdaUploadSheet">;
...
export default function PdaUploadSheet() {
  const t = useTheme();
  ...
  const goCamera = () => nav.replace("PdaCameraCapture", { patientId });
