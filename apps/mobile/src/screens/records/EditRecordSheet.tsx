...
import { listMyRecordProviders, patchRecord, type RecordProvider } from "@/lib/api";
...
export function EditRecordForm({ fileId, name, userProviderId, source, onClose, onSaved }: Props) {
  const t = useTheme();
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 24 }}>
          ...
          {loadingProviders ? (
            ...
            <Text style={[t.type.caption, { color: t.colors.textSecondary, paddingTop: 4 }]}>
              No providers found. Add a provider first to associate this record.
            </Text>
          ) : (
