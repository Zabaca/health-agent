...
function rowToFormData(row: UserProviderRow): ProviderFormData {
  return {
    ...
    historyPhysical: row.historyPhysical,
    diagnosticResults: row.diagnosticResults,
    treatmentProcedure: row.treatmentProcedure,
    prescriptionMedication: row.prescriptionMedication,
    imagingRadiology: row.imagingRadiology,
    dischargeSummaries: row.dischargeSummaries,
    specificRecords: row.specificRecords,
    specificRecordsDesc: row.specificRecordsDesc ?? undefined,
    dateRangeFrom: row.dateRangeFrom ?? undefined,
    dateRangeTo: row.dateRangeTo ?? undefined,
    allAvailableDates: row.allAvailableDates,
    purpose: row.purpose ?? undefined,
    purposeOther: row.purposeOther ?? undefined,
  };
}
